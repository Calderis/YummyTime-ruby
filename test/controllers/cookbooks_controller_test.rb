...
class CookbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post cookbooks_url, params: { cookbook: { user_id: @cookbook.user_id, count_time: @cookbook.count_time, description: @cookbook.description, persons_amount: @cookbook.persons_amount, recipes: @cookbook.recipes } }
    end
  ...
  test "should update cookbook" do
    patch cookbook_url(@cookbook), params: { cookbook: { user_id: @cookbook.user_id, count_time: @cookbook.count_time, description: @cookbook.description, persons_amount: @cookbook.persons_amount, recipes: @cookbook.recipes } }
