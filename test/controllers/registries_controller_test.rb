...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { cookbook_id: @registry.cookbook_id, recipe_id: @registry.recipe_id } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { cookbook_id: @registry.cookbook_id, recipe_id: @registry.recipe_id } }
